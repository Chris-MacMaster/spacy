...
Revision ID: 96a93aa5ad56
Revises:
Create Date: 2023-05-15 19:19:08.621758
...
def upgrade():
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE following_users SET SCHEMA {SCHEMA};")
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE user_shops SET SCHEMA {SCHEMA};")
