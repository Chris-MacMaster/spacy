      ...
      <div className="formParent">
        <form onSubmit={handleSubmit} className="wholeForm">
          <div className="headerAndReview">
            <div className="productPic">
              ...
              <div className="productName">
                ...
                <h3 className="review-form-text review-form-item-name">
          ...
          {hasSubmitted && errors.reviewLength && (
            <div className="error">* {errors.reviewLength}</div>
          )}

          <div className="submitButtonParent">
            <input
              onClick={handleSubmit}
              className="submit-button form-create-button red-styling edit-review-button"
              type="submit"
