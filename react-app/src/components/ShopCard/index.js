          ...
          ? filteredProducts
              .map((p, i) => (
                <NavLink to={`/products/${p.id}`}>
                  <img
                    className="shop-image-grid-image"
            ...
            <div className="shop-card-stars">
              {Array(5)
                ...
                .map((s, i) =>
                  s <= shopRating ? (
                    <i
                      className="fa-solid fa-star landing-shop-gold landing-shop-stars"
                      key={i}
                    ></i>
                  ) : (
                    <i
                      className="fa-solid fa-star landing-shop-blank landing-shop-stars"
                      key={i}
                    ></i>
                  )
                )}{" "}
