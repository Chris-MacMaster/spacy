      ...
      <div className="create-product-grid">
        <form className="create-product" onSubmit={handleSubmit}>
          <div className="create-product-label-side">
            <label className="create-product-label">Title</label>
          ...
          <div className="create-product-input-side">
            <input
              className="product-input input-field"
              type="text"
              value={name}
          ...
          <div className="create-product-input-side">
            <textarea
              className="product-input input-field description-input"
              type="textarea"
              value={description}
          ...
          <div className="create-product-label-side">
            <label className="create-product-label">Available</label>
            <div className="create-shop-grey">
          ...
          <div className="create-product-label-side">
            <label className="create-product-label">Free Shipping</label>
          ...
          <div className="create-product-input-side">
            <input
              className="product-input input-field check-box"
              type="checkbox"
              value={freeShipping}
            ...
            {hasSubmitted && errors.freeShipping && (
              <div className="error">* {errors.freeShipping}</div>
            )}
          </div>
          ...
          <div className="create-product-input-side">
            ...
            {hasSubmitted && errors.url1 && (
              <div className="error">* {errors.url1}</div>
            )}
          </div>
