    ...
    return (
        <div className='wholeModal whole-unfollow'>
            <div className='text'>
                ...
                <h3>Are you sure you want to unfollow this shop? It will disappear off your followed shops list.</h3>
            </div>
            <div className='buttons unfollow-shop-modal-buttons'>
                <div >
                    <button className='favorite-shop unfollow-button' onClick={handleUnfollow}>
