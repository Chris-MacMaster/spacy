...
export default function ShopPoliciesModal({ shop }) {
  ...
  return (
    <div className="shop-policies">
      <h1 id="shop-pol-title" className="shop-policies-title">
        Shop Policies for {shop.name}
      </h1>
      <p id="shop-pol-text" className="shop-policies-text">
        {shop.policies}
      </p>
      ...
      <p className="shop-policies-cancellations">
      ...
      <div className="credit-cards">
        <img
          ...
          alt="credit-cards"
          className="credit-cards-img"
        ></img>
        <p className="shop-policies-gift-cards">
          Accepts Spacey gift cards and Republic Credits
        </p>
        <p className="shop-policies-sharing">
