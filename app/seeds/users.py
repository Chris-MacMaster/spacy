...
def seed_users():
    carl_sagan = User(
        ...
        profile_pic='https://i.imgur.com/Eh7JsrQ.jpg')
    ...
    degrassetyson = User(
        ...
        profile_pic='https://i.imgur.com/4dvSGZW.jpg')
    ...
    scienceguy = User(
        ...
        profile_pic='https://i.imgur.com/8AtRpoC.jpg')
    ...
    neil_armstrong = User(
        ...
        profile_pic='https://i.imgur.com/AaqpID9.jpg')
    ...
    michio_kaku = User(
        ...
        profile_pic='https://i.imgur.com/thgykS9.jpg')
    ...
    john_glenn = User(
        ...
        profile_pic='https://i.imgur.com/0dyl9qq.jpg')
